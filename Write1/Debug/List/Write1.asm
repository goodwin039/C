...
; 0000 0036 DDRD=(0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0037 // State: Bit6=P Bit5=P Bit4=P Bit3=P Bit2=T Bit1=P Bit0=P
; 0000 0038 PORTD=(1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (0<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(123)
	OUT  0x12,R30
; 0000 0039 
