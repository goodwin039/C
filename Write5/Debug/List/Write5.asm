...
_main:
; .FSTART _main
; 0000 001D unsigned char sdvig = 0;
...
; 0000 002A // Function: Bit2=In Bit1=In Bit0=In
; 0000 002B DDRA=(0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	OUT  0x1A,R30
; 0000 002C // State: Bit2=T Bit1=T Bit0=T
; 0000 002D PORTA=(0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	OUT  0x1B,R30
; 0000 002E 
...
; 0000 0031 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
; 0000 0032 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
...
; 0000 0037 DDRD=(0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0038 // State: Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0039 PORTD=(1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(127)
	OUT  0x12,R30
; 0000 003A 
...
; 0000 005F TIMSK=(0<<TOIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<ICIE1) | (0<<OCIE0B) | (0<<TOIE0) | (0<<OCIE0A);
	OUT  0x39,R30
; 0000 0060 
; 0000 0061 // External Interrupt(s) initialization
; 0000 0062 // INT0: Off
; 0000 0063 // INT1: Off
; 0000 0064 // Interrupt on any change on pins PCINT0-7: Off
; 0000 0065 // Interrupt on any change on pins PCINT8-10: Off
; 0000 0066 // Interrupt on any change on pins PCINT11-17: Off
; 0000 0067 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
; 0000 0068 GIMSK=(0<<INT1) | (0<<INT0) | (0<<PCIE0) | (0<<PCIE2) | (0<<PCIE1);
	OUT  0x3B,R30
; 0000 0069 
; 0000 006A // USI initialization
; 0000 006B // Mode: Disabled
; 0000 006C // Clock source: Register & Counter=no clk.
; 0000 006D // USI Counter Overflow Interrupt: Off
; 0000 006E USICR=(0<<USISIE) | (0<<USIOIE) | (0<<USIWM1) | (0<<USIWM0) | (0<<USICS1) | (0<<USICS0) | (0<<USICLK) | (0<<USITC);
	OUT  0xD,R30
; 0000 006F 
...
; 0000 007A ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 007B // Digital input buffer on AIN0: On
; 0000 007C // Digital input buffer on AIN1: On
; 0000 007D DIDR=(0<<AIN0D) | (0<<AIN1D);
	LDI  R30,LOW(0)
	OUT  0x1,R30
; 0000 007E 
; 0000 007F 
...
; 0000 0083        if(PIND.0 == 0){
	SBIC 0x10,0
	RJMP _0x6
; 0000 0084          sdvig = 0b10000000;
	LDI  R17,LOW(128)
; 0000 0085          while (sdvig != 0)
_0x7:
	CPI  R17,0
	BREQ _0x9
; 0000 0086                {
; 0000 0087                 PORTB = sdvig ^ 0xff;
	RCALL SUBOPT_0x0
...
_0x6:
; 0000 008C             {
; 0000 008D               sdvig = 0b00000001;
	LDI  R17,LOW(1)
; 0000 008E               while (sdvig != 0)
_0xB:
	CPI  R17,0
	BREQ _0xD
; 0000 008F                     {
; 0000 0090                      PORTB = sdvig ^ 0xff;
	RCALL SUBOPT_0x0
