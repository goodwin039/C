...
; 0000 001D 
; 0000 001E // Crystal Oscillator division factor: 1
; 0000 001F #pragma optsize-
; 0000 0020 CLKPR=(1<<CLKPCE);
	LDI  R30,LOW(128)
	OUT  0x26,R30
; 0000 0021 CLKPR=(0<<CLKPCE) | (0<<CLKPS3) | (0<<CLKPS2) | (0<<CLKPS1) | (0<<CLKPS0);
	LDI  R30,LOW(0)
	OUT  0x26,R30
; 0000 0022 #ifdef _OPTIMIZE_SIZE_
; 0000 0023 #pragma optsize+
; 0000 0024 #endif
; 0000 0025 
; 0000 0026 // Input/Output Ports initialization
; 0000 0027 // Port A initialization
; 0000 0028 // Function: Bit2=In Bit1=In Bit0=In
; 0000 0029 DDRA=(0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	OUT  0x1A,R30
; 0000 002A // State: Bit2=T Bit1=T Bit0=T
; 0000 002B PORTA=(0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	OUT  0x1B,R30
; 0000 002C 
...
; 0000 002F DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
; 0000 0030 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
...
; 0000 0035 DDRD=(0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0036 // State: Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0037 PORTD=(1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(127)
	OUT  0x12,R30
; 0000 0038 
...
; 0000 0041 TCNT0=0x00;
	OUT  0x32,R30
; 0000 0042 OCR0A=0x00;
	OUT  0x36,R30
; 0000 0043 OCR0B=0x00;
	OUT  0x3C,R30
; 0000 0044 
...
; 0000 005D TIMSK=(0<<TOIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<ICIE1) | (0<<OCIE0B) | (0<<TOIE0) | (0<<OCIE0A);
	OUT  0x39,R30
; 0000 005E 
...
; 0000 0063 // Interrupt on any change on pins PCINT8-10: Off
; 0000 0064 // Interrupt on any change on pins PCINT11-17: Off
; 0000 0065 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
; 0000 0066 GIMSK=(0<<INT1) | (0<<INT0) | (0<<PCIE0) | (0<<PCIE2) | (0<<PCIE1);
	OUT  0x3B,R30
; 0000 0067 
; 0000 0068 // USI initialization
; 0000 0069 // Mode: Disabled
; 0000 006A // Clock source: Register & Counter=no clk.
; 0000 006B // USI Counter Overflow Interrupt: Off
; 0000 006C USICR=(0<<USISIE) | (0<<USIOIE) | (0<<USIWM1) | (0<<USIWM0) | (0<<USICS1) | (0<<USICS0) | (0<<USICLK) | (0<<USITC);
	OUT  0xD,R30
; 0000 006D 
...
; 0000 007B DIDR=(0<<AIN0D) | (0<<AIN1D);
	LDI  R30,LOW(0)
	OUT  0x1,R30
; 0000 007C 
; 0000 007D 
...
; 0000 0081       if (PIND.0 == 1){}
	SBIC 0x10,0
; 0000 0082         else {
	RJMP _0x7
; 0000 0083          if (PINB == 0xff) PORTB.0 = 0;
	IN   R30,0x16
	CPI  R30,LOW(0xFF)
	BRNE _0x8
	CBI  0x18,0
; 0000 0084          else PORTB.0 = 1;
	RJMP _0xB
_0x8:
	SBI  0x18,0
; 0000 0085         }
